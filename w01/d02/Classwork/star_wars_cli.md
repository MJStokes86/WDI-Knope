...
* In your classwork folder, create a directory called 'star_wars'
...
* Use the command line to add the text "...heavy breathing..." to the 'darth_vader' file. (how??? use the force', known as Google!)
...
* Create a file called 'princess_leia.txt' and add the text 'Help me, Obi-Wan...You're my only hope.'

* Create a file called 'obi_wan.txt'

* Create a file called 'luke_skywalker.txt'

* Create a directory called 'millenium_falcon'

* Inside the 'millenium_falcon', create two files: 'han_solo.txt' and 'chewy.txt'
