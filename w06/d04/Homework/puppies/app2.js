...
app.get('/', function(req, res){
  res.send(fs.readFileSync('./views/landing_page.html', 'utf8'));
});
...
app.post('/puppies/create', function(req, res){
  ...
  db.run("INSERT INTO puppies (breed, color, image) VALUES ('" + req.body.breed + "','" + req.body.color + "','" + req.body.image + "')");
...
app.get('/about', function(req, res){
  res.send("<h2>We love puppies! But then, who doesn't?</h2>");
});
